...
# $self->do_main(  )
#-----------------------------------------------------------------
# This method supplied by Billing::GEN::Status
...
Billing::Status - A controller in the Billing application
...
=head1 METHODS MIXED IN FROM Billing::GEN::Status
