...
use Billing::Model::GEN::invoice;

our $INVOICE = 'Billing::Model::invoice';
...
Billing::Model::invoice - model for invoice table (stub part)
...
=head1 METHODS (mixed in from Billing::Model::GEN::invoice)
