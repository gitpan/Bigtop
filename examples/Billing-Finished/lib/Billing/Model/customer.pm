...
use Billing::Model::GEN::customer;

our $CUSTOMER = 'Billing::Model::customer';
...
Billing::Model::customer - model for customer table (stub part)
...
=head1 METHODS (mixed in from Billing::Model::GEN::customer)
