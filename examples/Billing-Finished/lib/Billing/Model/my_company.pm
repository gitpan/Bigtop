...
use Billing::Model::GEN::my_company;

our $MY_COMPANY = 'Billing::Model::my_company';
...
Billing::Model::my_company - model for my_company table (stub part)
...
=head1 METHODS (mixed in from Billing::Model::GEN::my_company)
