...
use Billing::Model::GEN::line_item;

our $LINE_ITEM = 'Billing::Model::line_item';
...
Billing::Model::line_item - model for line_item table (stub part)
...
=head1 METHODS (mixed in from Billing::Model::GEN::line_item)
