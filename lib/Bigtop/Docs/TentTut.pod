...
See C<Bigtop::Docs::ScriptHelp::Style::Original> for a complete description
of how to define tables from the command line.
...
C<Bigtop::ScriptHelp::Style::Original> for how to specify columns, their
...
see C<Bigtop::ScriptHelp::Style::Original>.
...
app based on an existing postgres database, see C<Bigtop::ScriptHelp::Style>.
...
C<Bigtop::Docs::Keywords> for a list of valid keywords and their meanings,
and C<Bigtop::Docs::Sytnax> for full details.  If you need to write your
