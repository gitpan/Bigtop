...
With the development of ASCII art input, you can now build a complete
CRUD app from the command line alone.  Similarly, if you have a postgres 8
database, you can build a CRUD app for it from the command line.  See
